		...
		>
			...
			>
				...
				<div className="relative z-10 mx-auto max-w-4xl text-center">
					...
					<h2 className="font-serif text-3xl sm:text-4xl xl:text-5xl min-[1440px]:text-6xl font-normal mb-2 tracking-wide text-white">
						Achievements
					</h2>

					<p className="mx-auto max-w-2xl text-lg sm:text-xl xl:text-2xl min-[1440px]:text-3xl font-light leading-relaxed text-white/90">
