...
export default function Footer() {
	...
	return (
		<footer
			...
			<div className="flex w-full flex-col items-center gap-3 text-xs text-gold-light sm:text-base xl:text-lg min-[1440px]:text-xl md:flex-row md:justify-between md:gap-8">
