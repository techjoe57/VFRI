				...
				<div className="grid w-full gap-8 lg:grid-cols-[1fr_2fr] lg:gap-8">
					...
					<div className="relative z-10 order-1 flex flex-col items-center gap-4 text-center lg:order-1 lg:items-start lg:justify-center lg:text-left lg:gap-[clamp(16px,min(9vw,calc(32dvh_-_168px),calc(55px_+_(100vw_-_1024px)_*_0.16)),120px)]">
						<div className="flex flex-col items-center gap-4 lg:items-start">
							<span
								ref={eyebrowRef}
								className="rf-fade-up rf-delay-0 text-sm font-semibold uppercase tracking-[0.14em] text-gold min-[2560px]:text-base">
								A Victoria Falls Regional Institute Programme
							</span>

							<h1
								ref={headingRef}
								className="rf-fade-up rf-delay-1 font-sans text-5xl font-semibold leading-[1.05] tracking-tight text-ink xl:text-6xl min-[2560px]:text-7xl">
								Roots Forward
							</h1>
						</div>
...
<p className="max-w-md font-sans text-2xl font-medium leading-snug text-ink xl:text-3xl min-[2560px]:text-4xl">
							You carry a heritage you may have never stood
							inside.
						</p>

							<p className="max-w-md text-xl leading-relaxed text-ink-mid xl:text-2xl min-[2560px]:text-3xl">
							...
							<div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 lg:justify-start">
								<span className="text-lg font-medium uppercase tracking-[0.1em] text-ink-light min-[2560px]:text-xl">
