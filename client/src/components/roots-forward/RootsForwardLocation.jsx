...
<h2 className="font-sans text-3xl font-bold leading-tight tracking-tight text-ink xl:text-4xl min-[1440px]:text-5xl">
					...
					<p className="mt-6 font-sans text-2xl font-semibold leading-snug text-ink xl:text-3xl min-[1440px]:text-4xl">
						For some, this will be a return. For others, a
						first arrival. Both matter.
					</p>

					<p className="mt-6 text-lg leading-relaxed text-ink-mid xl:text-xl min-[1440px]:text-2xl">
