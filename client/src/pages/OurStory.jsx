			...
			<div className="flex min-h-[100dvh] w-full max-w-full flex-1 flex-col bg-black/35">
				...
				<section className="relative px-6 pb-3 pt-32 sm:pt-28">
					<div className="mx-auto max-w-4xl text-center text-white">
						<h1 className="mb-3 font-display text-5xl xl:text-6xl min-[2560px]:text-7xl">
							Our Story
						</h1>

						<p className="text-lg leading-relaxed text-white/90 xl:text-xl min-[2560px]:text-2xl">
