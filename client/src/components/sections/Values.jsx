...
export default function Values() {
  ...
  const renderCard = ({ title, desc, icon: Icon }) => (
    <div
      ...
      "
    >
      <Icon className="mb-3 text-2xl text-gold-light transition-transform duration-300 group-hover:scale-110" />

      <h4 className="card-title mb-2 text-white">{title}</h4>
  ...
  return (
    <section
      id="values"
      className="relative overflow-hidden bg-green-deep/90 backdrop-blur-sm pt-6 pb-4"
    >
      {/* Kente */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div
          ref={headRef}
          className="reveal max-w-4xl mx-auto text-center mb-4"
        >
          <span
